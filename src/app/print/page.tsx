    ...
    <div className="print-root space-y-12">
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 text-sm text-neutral-700 leading-relaxed">
          ...
          <p>
            제품을 만들고 운영한 경험으로 요구사항 뒤의 맥락을 읽고 비즈니스 성과로
            연결합니다.
          </p>
          <p>
            ATS SaaS에서는 챕터 리드로 Turborepo 모노레포 전환·FSD 도입을 주도해 한
            레포의 순환 참조 46%를 제거했고, SPA → Next.js 마이그레이션으로 LCP를 30%
            개선했습니다(Lighthouse 기준). 검증·팀 내 공유로 기술 도입을 합의 기반으로
            이끌었습니다.
          </p>
          <p>
            이후 공동창업한 온보딩 서비스에서는 프론트엔드 전담으로 자동화 플로우를
            설계·구현해, 인사담당자가 코드 없이 온보딩 프로세스를 운영할 수 있는 환경을
