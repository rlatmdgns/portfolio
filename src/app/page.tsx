      ...
      <section className="space-y-5">
        ...
        <div className="space-y-4 text-base leading-relaxed text-neutral-600 dark:text-neutral-200 max-w-xl">
          <p>
            ...
            시스템의 지속 가능성까지 직접 설계합니다.
          </p>
          <p>
            Turborepo 모노레포 전환과 FSD 도입을 주도해 순환 참조 46%를
            제거했고, 별도로 SPA → Next.js 마이그레이션을 통해 LCP를 30%
            개선했습니다(Lighthouse 기준).
          </p>
          <p>
            공동창업한 서비스에서는 온보딩 자동화 플로우를 프론트엔드 전담으로
            개발해 인사담당자가 코드 없이 온보딩 프로세스를 설계·운영할 수 있는
            환경을 만들었고, 챕터 리드로서 PoC 검증과 팀 내 공유를 통해 기술
            도입을 합의 기반으로 이끌었습니다.
          </p>
        </div>
